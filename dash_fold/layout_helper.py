...
def run_standalone_app(layout, callbacks, header_colors, filename):
    ...
    app.layout = app_page_layout(
        page_layout=layout(), app_title=app_title, app_name=app_name, standalone=True, **header_colors()
    )
            ...
            html.Div(
                ...
                children=[
                        ...
                        children=[
                            html.Img(
                                src="data:image/png;base64,{}".format(
                                    base64.b64encode(open("./assets/plotly-dash-bio-logo.png", "rb").read()).decode()
                                )
                            )
                        ],
                    ...
                    html.A(
                        ...
                        "blob/master/tests/dashbio_demos/dash-{}/app.py".format(app_name),
                        style={
                    ...
                    html.Img(
                        src="data:image/png;base64,{}".format(
                            base64.b64encode(
                                open(
                                    "./assets/GitHub-Mark-{}64px.png".format("Light-" if light_logo else ""), "rb"
                                ).read()
                            ).decode()
                        )
                    ),
